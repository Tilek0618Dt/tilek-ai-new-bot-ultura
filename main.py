    ...
    try:
        response = requests.post(
            ...
            headers={
                ...
                "HTTP-Referer": "https://t.me/tilek_ai_bot",  # Сенин ботуңуздун шилтемеси
                "X-Title": "Tilek AI Bot"  # Боттун аты
            },
            json={
                ...
                "temperature": 0.8,
                "max_tokens": 1000  # Биринчи коддогудай чоңураак
            },
            timeout=60
        )
...
def start(message):
    bot.reply_to(message, "Салам! Мен Тилек AI — Кыргызстандын биринчи толук кыргызча AI! 😎\nСуроо бер, жооп берем!")
